 ...
 */
public class WithoutWindow extends Room{
    ...
    public WithoutWindow(String name, double length, double width, double lumen) {
        super(name, length, width);
        this.lumen = lumen;
    }

    public WithoutWindow(String name, double length, double width, Purpose purpose, double lumen) {
