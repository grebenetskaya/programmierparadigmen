 ...
 */
public class WithWindowGen extends RoomGen {
    ...
    public WithWindowGen(String name, double length, double width, double windowArea) {
        super(name, length, width);
        this.windowArea = windowArea;
    }

    public WithWindowGen(String name, double length, double width, PurposeGen purpose, double windowArea) {
